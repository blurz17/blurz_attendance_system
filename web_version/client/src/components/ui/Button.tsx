...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
    {
        variants: {
            variant: {
                default:
                    "bg-primary-600 text-white shadow hover:bg-primary-700 shadow-primary-500/20",
                destructive:
                    "bg-error/90 text-white shadow-sm hover:bg-error",
                outline:
                    "border border-border bg-transparent shadow-sm hover:bg-surface-muted hover:text-text-primary",
                secondary:
                    "bg-navy-600 text-white shadow-sm hover:bg-navy-700",
                ghost: "hover:bg-surface-muted hover:text-text-primary",
                link: "text-primary-600 underline-offset-4 hover:underline",
                gradient: "gradient-primary text-white shadow-lg shadow-primary-500/30 hover:opacity-90",
            },
            size: {
